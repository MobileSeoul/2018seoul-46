...
public class HashBroadcastIdSerializer extends StdSerializer<Long> {
    public HashBroadcastIdSerializer() {
        this(null);
    }

    public HashBroadcastIdSerializer(Class<Long> t) {
        super(t);
    }
    ...
    public void serialize(Long aLong, JsonGenerator jsonGenerator, SerializerProvider serializerProvider)
            throws IOException {
        jsonGenerator.writeString(HashIdUtils.encryptId(HashIdType.BROADCAST_ID, aLong));
    }
